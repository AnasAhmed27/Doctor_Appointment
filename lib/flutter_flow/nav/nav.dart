...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => const FindDoctorWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => const FindDoctorWidget(),
        ),
        FFRoute(
          name: 'HomePage',
          path: '/homePage',
        ...
        FFRoute(
          name: 'FindDoctor',
          path: '/findDoctor',
          builder: (context, params) => const FindDoctorWidget(),
        ),
        FFRoute(
          name: 'Appointment',
          path: '/appointment',
        ...
        FFRoute(
          name: 'TimeSlot',
          path: '/timeSlot',
          builder: (context, params) => const TimeSlotWidget(),
        ),
        FFRoute(
          name: 'MyAppointment',
          path: '/myAppointment',
          builder: (context, params) => const MyAppointmentWidget(),
        ),
        FFRoute(
          name: 'Medication',
          path: '/medication',
